...
export default function CreateStoryPage() {
  ...
  // Ajout d'une nouvelle tâche vide
  const addTache = () => setTaches([...taches, '']);

  // Modification d'une tâche par index
  ...
  // Suppression d'une tâche par index
  const removeTache = (index: number) => {
    const newTaches = taches.filter((_, i) => i !== index);
    setTaches(newTaches.length ? newTaches : ['']); // au moins une tâche vide
  };
